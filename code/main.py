...
parameters = {
    ...
    "BETA" : 0.5, #Exponential weight of desirability on walk probabilities
    ...
    "ant_numbers" : 100, #Number of ants walking in a cycle
    "cycles" : 30, #Number of cycles
    "dataset" : 'teste2.txt' #File name that contains job/machine times
}
